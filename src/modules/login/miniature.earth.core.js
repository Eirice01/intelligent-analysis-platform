import hologram_map from './hologram-map.svg'
import hologram_shine from './hologram-shine.svg'
...
export default function() {
  ...
  var $myearth = document.getElementById('myearth');
    ...
    setTimeout(function(){ $myearth.style.opacity = 1; }, 200);
  ...
  function pulse(index) {
    ...
    sprites[index].animate('scale', 0.75, {
      easing: 'out-quad', duration: 300, complete: function () {
        this.animate('scale', 0.01, {
          easing: 'in-quad', duration: 300, complete: function () {
